...
<body class="textShadow"> 
  ...
  <form id="registerForm" name="registerForm"  action="register_proc.php" onsubmit="return checkRegForm()" method="POST">
    ...
    <input class="inputBoxStyle" id="name_first" type="text" name="name_first" maxlength="255"/>
    <br/><br/>
    
    <span class="formLabel">Last Name</span>
    <input class="inputBoxStyle" id="name_last" type="text" name="name_last" maxlength="225"/>
    <br/><br/>
    
    <span class="formLabel">Password</span>
    <input class="inputBoxStyle" id="password1" type="password" name="password1" maxlength="225"/>
    <br/><br/>
    
    <span class="formLabel">Repeat Password</span>
    <input class="inputBoxStyle" id="password2" type="password" name="password2" maxlength="225"/>
    <br/><br/>
    
    <span class="formLabel">Username</span>
    <td><input class="inputBoxStyle" id="username" type="text" name="username" maxlength="225"/>
    <br/><br/>
