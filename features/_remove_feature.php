...
$annotations_q = "SELECT spec FROM $gene_table WHERE id ='$gene_id'";
...
if(!$used) {
  ...
  $features_q = "SELECT features FROM $gene_table WHERE id = '$gene_id'";
  ...
  $set_features_q = "UPDATE $gene_table SET features = '$features_json' WHERE id='$gene_id'";
