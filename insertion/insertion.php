    ...
    <div id="background_transparent"></div>
      ...
      <div id="div_main">
        ...
        <div id="div_top_bar">
          ...
          <div class="" id="div_upload"><a href="../upload/upload_dna.php">Upload</a></div>
          ...
          <div id="div_nav">
            <nav>
              <ul id="nav_bar">
                ...
                <li class="nav_bar_items"><a class="nav_bar_items" id="selected" href="insertion.php">Insertion</a></li>
