      ...
      <div id="div_main">
        ...
        <div id="div_top_bar">
          ...
          <div id="div_nav">
            <nav>
              <ul id="nav_bar">
                <li class="nav_bar_items"><a class="nav_bar_items" id="" href="substitution.php">Substitution</a></li>
            ...
            <div id="div_content_box_main">
              <div id="div_content_box_main_A">
                <div id="div_content_box_main_A1">
                  ...
                  <span class="content_detail_format">Please choose a name for your gene</span>
                  <hr>
                  <input type="text" name="nameOfDNA" id="dna_name" />
                </div>
                <div id="div_content_box_main_A2">
                  <span class="content_title_format">UPLOAD</span> </br>
                  <span class="content_detail_format">Please upload the gene sequence in ".txt" format</span>
                  <hr>
                ...
                <div id="div_content_box_main_B">
                  <div id="div_content_box_main_B1">
                    ...
                    <span class="content_detail_format">Jot down any notes you want for this gene</span>
                    <hr>
                    <textarea id="dna_notes"></textarea>
                  </div>
